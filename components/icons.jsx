export function WhatsAppIcon({ className = "h-5 w-5" }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M16.02 3C9.4 3 4 8.37 4 15c0 2.34.65 4.53 1.78 6.4L4 29l7.8-1.73A11.9 11.9 0 0 0 16.02 27C22.65 27 28 21.63 28 15S22.65 3 16.02 3Zm0 21.8a9.7 9.7 0 0 1-4.94-1.35l-.35-.21-4.63 1.03 1.02-4.5-.23-.37A9.72 9.72 0 0 1 6.2 15c0-5.4 4.4-9.8 9.82-9.8 5.42 0 9.82 4.4 9.82 9.8 0 5.4-4.4 9.8-9.82 9.8Zm5.4-7.35c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.47-.89-.79-1.48-1.76-1.66-2.06-.17-.3-.02-.46.13-.61.14-.14.3-.35.45-.53.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.6-.92-2.2-.24-.57-.49-.5-.67-.5-.17-.01-.37-.01-.57-.01-.2 0-.52.07-.79.37-.27.3-1.04 1.02-1.04 2.47 0 1.46 1.06 2.87 1.21 3.07.15.2 2.09 3.19 5.06 4.47.71.3 1.26.49 1.69.62.71.23 1.36.2 1.87.12.57-.08 1.76-.72 2.01-1.42.25-.7.25-1.29.17-1.42-.07-.13-.27-.2-.57-.35Z" />
    </svg>
  );
}
...
export function FacebookIcon({ className = "h-5 w-5" }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M14.5 21v-7h2.4l.4-3H14.5V9.1c0-.87.24-1.46 1.5-1.46h1.6V5.02C17.3 5 16.3 4.9 15.2 4.9c-2.34 0-3.94 1.43-3.94 4.05V11H8.8v3h2.46v7h3.24Z" />
    </svg>
  );
}
