...
// basePrice is the low end of the displayed range — used as the concrete
// figure the deposit is calculated on. Final add-on pricing is confirmed
// after the brief is reviewed; the form makes clear the deposit is based on
// this starting price.
export const ADD_ONS = [
  { id: "logo", name: "Logo Design", price: "R800 – R1,500", basePrice: 800 },
  { id: "copywriting", name: "Copywriting", price: "R1,000 – R2,500", basePrice: 1000 },
  { id: "extraPage", name: "Extra Page", price: "R500 – R800", basePrice: 500 },
];
...
export const PAYMENT_PLANS = [
  ...
  },
  {
    ...
    description:
      "Three equal payments: one now, one at the build milestone, one on completion.",
    depositPercent: 1 / 3,
...
export function calculatePricing({ packageId, addOnIds = [], paymentPlanId }) {
  ...
  const depositDue = Math.round(total * plan.depositPercent);
